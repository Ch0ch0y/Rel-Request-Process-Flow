          ...
          >
            ...
            <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
              <p>
                ...
                CADMS — the Construction Analysis Data Management System. What you're looking at is something I built entirely from
                the ground up — every line of code, every UI detail, and every workflow decision was crafted with
                one goal in mind: to make the lives of the Construction Analysis team at Amkor Technology a
                little easier.
              </p>
              <p>
                Before this system existed, tracking CA requests meant navigating spreadsheets, emails,
              ...
              <p>
                I hope this tool serves you well. Whether you're an engineer submitting a request, an analyst
                performing the analysis, or a manager reviewing progress — this was built for you.
              </p>
